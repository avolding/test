...
<?php print $polyfills; ?>
        ...
        <link rel="stylesheet" href="/sites/all/themes/searchify/css/searchify.css">
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.1/jquery.min.js"></script>
    <script src="//ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/jquery-ui.min.js"></script>
    <script src="http://localhost/searchier/sites/all/themes/searchify/js/jquery-1.10.1.min.js">
        < \/script>')
    </script>
    <script src="/sites/all/themes/searchify/js/bootstrap.min.js"></script>
