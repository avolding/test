...
<header class="ahead">
    ...
    <div class="anav">
      ...
      <ul>
        <li class="amain"><a href="<?php print url('<front>'); ?>">SEARCHIER.COM</a></li>

        <li class="aright"><a href="#" data-toggle="modal" data-target="#myMenuModal">MENU</a></li>
        <li class="aright"><a href="#">REGISTER</a></li>
        <li class="aright"><a href="#">SIGN IN</a></li>
      </ul>
    </div>
  </header>
...
if ( $user->uid ) {
  // Logged in user
  print "<li class='aright'><a href='#' data-toggle='modal' data-target='#myMenuModal'>MENU</a></li>";
}
else {
  // Not logged in
  print "<li class='aright'><a href='#' data-toggle='modal' data-target='#myMenuModal'>MENU</a>
        ...
        <li class='aright'><a href='user/register'>REGISTER</a></li>
        <li class='aright'><a href='/user'>SIGN IN</a>"; 
}
?>
...
<!-- Modal -->
    <div class="modal fade" id="myMenuModal" >
                ...
                <div class="modal-menu">
                    <?php
$menu = menu_navigation_links('menu-logged-out');
print theme('links__menu_logged-out', array('links' => $menu));
?>
